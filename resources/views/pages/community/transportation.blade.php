...
<section class="w-full bg-[#FFFDF9] py-16">
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="text-center max-w-2xl mx-auto mb-16">
            ...
            <h1 class="text-[#234433] text-3xl md:text-4xl emphasis tracking-tight">Modes of Transportation</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div class="bg-white border border-gray-100 p-6 rounded-sm shadow-xs flex flex-col justify-between">
                <div>
                    ...
                    <h3 class="text-[#234433] emphasis text-lg mb-2">The Water Highway</h3>
            ...
            <div class="bg-white border border-gray-100 p-6 rounded-sm shadow-xs flex flex-col justify-between">
                <div>
                    <div class="text-2xl mb-4">📦</div>
                    <h3 class="text-[#234433] emphasis text-lg mb-2">Sustenance &amp; Ritual</h3>
                    <p class="text-gray-600 text-xs md:text-sm leading-relaxed">
            ...
            <div class="bg-white border border-gray-100 p-6 rounded-sm shadow-xs flex flex-col justify-between">
                <div>
                    <div class="text-2xl mb-4">🥾</div>
                    <h3 class="text-[#234433] emphasis text-lg mb-2">Land Alternatives</h3>
                    <p class="text-gray-600 text-xs md:text-sm leading-relaxed">
        ...
        <div class="mt-12 bg-[#F7F5F0] border border-gray-200/60 p-6 rounded-sm flex flex-col sm:flex-row items-start gap-4">
            ...
            <div>
                <h4 class="text-[#234433] emphasis text-sm uppercase tracking-wide">Weather Dependency &amp; Vulnerability</h4>
