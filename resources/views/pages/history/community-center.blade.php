    ...
    <section class="max-w-5xl mx-auto px-6 py-20">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
            ...
            <div class="md:col-span-8 text-gray-600 space-y-6 text-sm md:text-base leading-relaxed">
                ...
                <p>
                    The construction of the <span class=" font-medium">Plah Dhee</span> was made possible through dedicated financial assistance from distinguished local figures, including retired British Gurkha <strong class="text-gray-900 font-medium">Lt. Bhim Prasad Gurung</strong>, retired Indian Army <strong class="text-gray-900 font-medium">Captain Bishnu Gurung</strong>, alongside <strong class="text-gray-900 font-medium">Batti Prasad Gurung</strong>, <strong class="text-gray-900 font-medium">Jagat Bahadur Gurung</strong>, and <strong class="text-gray-900 font-medium">Sushil Gurung</strong>. 
                </p>
                <p>
                    This specialized structure provides the precise ritual environment needed by the <strong class="text-gray-900 font-medium">Pachyu</strong> and <strong class="text-gray-900 font-medium">Ghyabri</strong> (traditional priests) to conduct delicate ceremonies during <span class=" font-medium">Pye Karya</span>. Today, the entire community center operates seamlessly as a pristine public property—shielding ancestral customs, hosting lively civic meetings, and standing ready to welcome up to 300 guests under one unified roof.
                </p>
            </div>
        </div>
    </section>
