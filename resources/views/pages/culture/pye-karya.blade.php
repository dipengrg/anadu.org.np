...
@section('title')
    Pye Karya | Talpari Anadu
@endsection

@section('content')
<!-- Main Content Area: Pye Karya (Arghau) -->
<main id="pye-karya-arghau-content" class="w-full">
    ...
    <section class="max-w-5xl mx-auto px-6 py-12">
        <div class="bg-[#F7F5F0] border border-gray-200/60 rounded-sm p-8 md:p-12 shadow-sm font-sans">
    ...
    <!-- Section: Chronology of the 4-Day Ritual -->
    <section class="bg-white py-16 border-y border-gray-100">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="space-y-16 max-w-4xl mx-auto">
                ...
                <!-- Day 2: Building the Plah & Pathfinding -->
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start">
                    <div class="md:col-span-3">
                    ...
                    <div class="md:col-span-9 text-gray-600 text-sm md:text-base leading-relaxed space-y-3">
                        <p>
                            On the second day, a symbolic effigy named the <strong class="text-gray-900 font-medium">"Plah"</strong> is woven out of bamboo splits and dressed in the authentic, fine garments of the deceased, serving as a temporary physical vessel for the wandering spirit. 
                        </p>
                        <p>
                            Throughout the day, the spiritual masters chant the sacred <strong class="text-[#234433] font-semibold">"Pye-Tã"</strong> (the oral historical texts of the Tamu people), map out an intricate spiritual route for the soul, and guide it safely across mountains, deep forests, rivers, and lakes toward the ancestral paradise. A signature highlight of this day is the specialized <span class="font-medium text-gray-900">"Bone Identification" (Astu Pahichan)</span> dance performed between the Klhepri and the sons-in-law. The Klhepri must utilize his spiritual powers to locate the hidden bone fragment concealed by the sons-in-law, proving the absolute purity of the soul and its unyielding bond to the clan.
                        </p>
                    </div>
                </div>
                ...
                <!-- Day 3: Kyuñ Chhaawa & Final Severing -->
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start">
                    <div class="md:col-span-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-start">
                    ...
                    <div class="md:col-span-9 text-gray-600 text-sm md:text-base leading-relaxed space-y-3">
                        <p>
                            The fourth day shifts from mourning into a joyous celebration of successful completion and deep communal gratitude. The family and clan offer the formal <strong class="text-gray-900 font-medium">"Syai-Syai"</strong> honor, expressing immense gratitude to the Pachyu, Klhepri, maternal uncles, sons-in-law, and married daughters who worked tirelessly to execute the complex funeral rites.
                        </p>
                        <p>
                            This final gathering beautifully cements and fortifies interpersonal relationships between the living family, the community, and the priesthood. To formally conclude the Arghau ceremony, the local Aama Samuha (Mothers' Group) and village society organize traditional cultural dances and music, transforming the heavy atmosphere of grief into a beautiful display of social solidarity, mutual comfort, and collective joy.
                        </p>
                    </div>
                </div>
