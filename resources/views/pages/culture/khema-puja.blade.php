    ...
    <section class="max-w-5xl mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
            ...
            <div class="md:col-span-8 text-gray-600 space-y-6 text-sm md:text-base leading-relaxed">
                <p>
                    Every year on the auspicious morning of <strong class="text-gray-900 font-medium">Magh 1st (हरेक वर्ष माघ १ गतेको शुभ बिहानीमा)</strong>, when a thick blanket of winter mist settles softly over the surface of Fewa Lake (<span class=" font-medium">जब फेवातालको सतहमा बाक्लो कुहिरोले ढाकिएको हुन्छ</span>), a deeply moving tradition unfolds. The brothers and sisters of the Tamu community from Taalpaari Anadu village gather at the water's edge, carrying a profound ancient legacy to remember and worship their ancestors (<span class=" font-medium">तालपारी अनदुँ गाउँका तमु समुदायका दाजुभाइ तथा दिदीबहिनीहरू एउटा प्राचीन विरासत बोकेर तालको किनारमा आफ्ना पुर्खा लाई सम्झिदई पुजा गर्ने गरिन्छ</span>).
                </p>
                <p>
                    In the sacred path taught by the ancestors—the <strong class="text-gray-900 font-medium">Khé (खें - Paternal Ancestors)</strong> and <strong class="text-gray-900 font-medium">Mā (माँ - Maternal Ancestors)</strong>—nature is never treated as a lifeless, inanimate object (<span class=" font-medium">हाम्रा पुर्खाहरू खें "पितृ" र माँ "मातृ" ले सिकाउनुभएको यो मार्गमा प्रकृतिलाई कुनै निर्जीव वस्तु मानिँदैन</span>). Standing as a living witness to this bond is the lake itself, historically known in Tamu Kyi as <strong class="text-[#234433] font-semibold">Phyõb Tal (फ्योँब ताल / फेवाताल)</strong>.
                </p>
                <div class="bg-[#F7F5F0] p-5 rounded-sm border-l-2 border-[#C5A880] text-xs font-serif text-gray-700">
                    "यो पुजाले के सिकाउँछ भने—हाम्रा पुर्खाहरू कतै टाढा छैनन्, उनीहरू त यी ताल हिमाल र यो धर्तीमा समाहित छन्।"
                    <span class="font-sans font-bold uppercase tracking-wider text-gray-400 block text-[10px] not- mt-2">The Cosmic Belief: Ancestors are one with the Lake, Mountains, and Earth</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
                ...
                <div class="md:col-span-7 text-gray-600 space-y-6 text-sm md:text-base leading-relaxed">
                    ...
                    <p>
                        There is a deep and growing concern within the community that our original, indigenous customs and rituals might eventually be washed away and lost in the sweeping current of modern globalization (<span class=" font-medium">आधुनिकताको लहरमा कतै हाम्रा मौलिक रितिरिवाजहरू नहराउन् भन्ने चिन्ता हामीमाझ छ</span>). Preserving <strong class="text-gray-900 font-medium">Khema Puja</strong> is not just about keeping an ancient ritual alive; it is about protecting the distinct ancestral roots that give the Tamu people their unique place under the Himalayan sky.
                    </p>
                </div>
