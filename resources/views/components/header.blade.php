<header class="sticky top-0 z-50 bg-anadu-base/90 backdrop-blur-md py-6">
    <div class="container mx-auto px-6 relative">
        ...
        <div class="flex flex-col items-center">
            <a href="{{ url('/') }}" class="flex flex-col items-center group transition-transform hover:scale-105">
                ...
                <span class="mt-2 text-[10px] md:text-xs font-medium text-anadu-gold emphasis border-t border-anadu-gold/20 pt-1 tracking-wider text-center">
                    @if($locale == 'en')
