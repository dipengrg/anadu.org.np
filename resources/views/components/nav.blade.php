<nav>
    ...
    <div class="hidden lg:flex container mx-auto px-6 py-8 flex-wrap justify-center gap-x-8 gap-y-2 font-medium text-sm tracking-wide uppercase text-anadu-forest/80">
        ...
        <!-- 1. Home -->
        <a href="/" class=" {{ request()->is('/') ? 'text-anadu-gold' : 'hover:text-anadu-gold' }} transition">HOME</a>

        <!-- 2. History -->
        <div class="relative group">
            <button class=" flex items-center gap-1 {{ request()->is('history*') ? 'text-anadu-gold' : 'group-hover:text-anadu-gold' }} transition">
                <span>HISTORY</span>
            ...
            <div class="absolute left-0 w-56 bg-anadu-base border border-anadu-gold/10 shadow-xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-2">
                <p class="text-xs text-anadu-gold  tracking-wider px-4 py-2">Origins &amp; Foundations</p>
        ...
        <!-- 4. Culture -->
        <div class="relative group">
            <button class=" flex items-center gap-1 {{ request()->is('culture*') ? 'text-anadu-gold' : 'group-hover:text-anadu-gold' }} transition">
                <span>CULTURE</span>
                <svg class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="absolute left-1/2 -translate-x-1/2 w-[550px] bg-anadu-base border border-anadu-gold/10 shadow-2xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="grid grid-cols-2 gap-6 p-6">
                    <div>
                        <p class="text-xs text-anadu-gold  tracking-wider mb-3">Traditions that define us</p>
                        <ul class="space-y-2">
        ...
        <!-- 5. Community -->
        <div class="relative group">
            <button class=" flex items-center gap-1 {{ request()->is('community*') ? 'text-anadu-gold' : 'group-hover:text-anadu-gold' }} transition">
                <span>COMMUNITY</span>
                <svg class="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </button>
            <div class="absolute right-0 w-56 bg-anadu-base border border-anadu-gold/10 shadow-xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-2">
                <p class="text-xs text-anadu-gold  tracking-wider px-4 py-2">Building our future together</p>
        ...
        <!-- 6. Eco Tourism -->
        <div class="relative group">
            <button class=" flex items-center gap-1 {{ request()->is('eco-tourism*') ? 'text-anadu-gold' : 'group-hover:text-anadu-gold' }} transition">
            ...
            <div class="absolute right-0 w-60 bg-anadu-base border border-anadu-gold/10 shadow-xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-2">
                <p class="text-xs text-anadu-gold  tracking-wider px-4 py-2">Responsible Travel &amp; Trails</p>
        ...
        <!-- 7. Contact -->
        <a href="/contact" class=" {{ request()->is('contact') ? 'text-anadu-gold' : 'hover:text-anadu-gold' }} transition">CONTACT</a>
    </div>
</nav>